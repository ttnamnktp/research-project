...
for i in range(1,10):
    ...
    trainer = pl.Trainer(accelerator='cuda',
                         ...
                         logger=[pl_loggers.TensorBoardLogger('./logs/', name="linear_probe_EEGPT_BCIC2B_tb", version=f"subject{i}"), 
                                 pl_loggers.CSVLogger('./logs/', name="linear_probe_EEGPT_BCIC2B_csv")])
