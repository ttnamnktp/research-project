...
class LitEEGPTCausal(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        lr_scheduler = torch.optim.lr_scheduler.OneCycleLR(optimizer, max_lr=[1e-3, 1e-3, 1e-3], steps_per_epoch=steps_per_epoch, epochs=max_epochs, pct_start=0.1)
...
def main():
    ...
    for i in range(1,10):
        ...
        checkpoint_callback = pl.callbacks.ModelCheckpoint(
            dirpath=f"./EEGPT/ds_checkpoints/linear_probe_EEGPT_BCIC2B_on_test/subject{i}",
        ...
        trainer = pl.Trainer(accelerator='cuda',
                            ...
                            logger=[pl_loggers.TensorBoardLogger('./logs/', name="linear_probe_EEGPT_BCIC2B_on_test_tb", version=f"subject{i}"), 
                                    pl_loggers.CSVLogger('./logs/', name="linear_probe_EEGPT_BCIC2B_on_test_csv", version=f"subject{i}")])
