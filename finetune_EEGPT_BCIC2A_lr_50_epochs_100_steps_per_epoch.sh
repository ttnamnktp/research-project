#!/bin/bash
#SBATCH --job-name=finetune_EEGPT_BCIC2A_lr_50_epochs_100_steps_per_epoch
...
# chạy training
# ======================
srun python -u EEGPT/downstream/finetune_EEGPT_BCIC2A_lr_50_epochs_100_steps_per_epoch.py