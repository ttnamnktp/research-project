...
def main():
    ...
    for i in range(1,10):
        ...
        trainer = pl.Trainer(accelerator='cuda',
                            ...
                            logger=[pl_loggers.TensorBoardLogger('./logs/', name="finetune_EEGPT_BCIC2A_lr_50_epochs_100_steps_per_epoch_tb", version=f"subject{i}"), 
                                    pl_loggers.CSVLogger('./logs/', name="finetune_EEGPT_BCIC2A_lr_50_epochs_100_steps_per_epoch_csv")])
