...
from models import model_for_faced, model_for_seedv, model_for_physio, model_for_shu, model_for_isruc, model_for_chb, \
    ...
    model_for_bciciv2a, model_for_bciciv2a_adapter
...
def main():
    ...
    parser.add_argument('--use_adapter', type=lambda x: x.lower() == 'true', default=False,
                        help='True, False')
    parser.add_argument('--adapter_channels', type=int, default=22,
                        help='12,22,32')
    ...
    parser.add_argument('--datasets_dir', type=str,
                        default='datasets/downstream/lmdb_0_38Hz',
                        help='datasets_dir')
    ...
    for i in range(1, 10):
        print("\n" + "="*50)
        print(f"RUN LOSO A0{i}")
        print("="*50)

        # dataset path
        params.datasets_dir = os.path.join(root_dir, f"LOSO_A0{i}")
        ...
        # model
        model = model_for_bciciv2a_adapter.Model(params)
