...
def main():
    ...
    for i in range(1,10):
        ...
        checkpoint_callback = pl.callbacks.ModelCheckpoint(
            dirpath=f"./EEGPT/ds_checkpoints/finetune_EEGPT_BCIC2A_lr_1e-5_on_test/subject{i}",
        ...
        trainer = pl.Trainer(accelerator='cuda',
                            ...
                            logger=[pl_loggers.TensorBoardLogger('./logs/', name="finetune_EEGPT_BCIC2A_lr_1e-5_on_test_tb", version=f"subject{i}"), 
                                    pl_loggers.CSVLogger('./logs/', name="finetune_EEGPT_BCIC2A_lr_1e-5_on_test_csv", version=f"subject{i}")])
