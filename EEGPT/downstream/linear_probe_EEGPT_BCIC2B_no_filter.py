...
from utils import *
import math
data_path = "/home/infres/ttran-25/project/datasets/downstream/Data/BCIC_2b"
seed_torch(8)
for i in range(1,10):
    all_subjects = [i]
    all_datas = []
    ...
    trainer = pl.Trainer(accelerator='cuda',
                         ...
                         logger=[pl_loggers.TensorBoardLogger('./logs/', name="linear_probe_EEGPT_BCIC2B_no_filter_tb", version=f"subject{i}"), 
                                 pl_loggers.CSVLogger('./logs/', name="linear_probe_EEGPT_BCIC2B_no_filter_csv")])
