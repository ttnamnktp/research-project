...
def main():
    ...
    # load configs
    data_path = "/home/infres/ttran-25/project/datasets/downstream/Data/BCIC_2a"
    # used seed: 7
    seed_torch(8)
    for i in range(1,10):
        all_subjects = [i]
        ...
        trainer = pl.Trainer(accelerator='cuda',
                            ...
                            logger=[pl_loggers.TensorBoardLogger('./logs/', name="linear_probe_EEGPT_BCIC2A_no_filter_tb", version=f"subject{i}"), 
                                    pl_loggers.CSVLogger('./logs/', name="linear_probe_EEGPT_BCIC2A_no_filter_csv")])
