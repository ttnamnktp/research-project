...
class LitEEGPTCausal(pl.LightningModule):
    ...
    def __init__(self, load_path="/home/infres/ttran-25/project/EEGPT/checkpoint_/eegpt_mcae_58chs_4s_large4E.ckpt"):
        ...
        self.chan_conv_proj = nn.Conv1d(22, 19, 1)
    ...
    def forward(self, x):
        ...
        x = self.chan_conv(x) + self.chan_conv_proj(x)
...
def main():
    ...
    for i in range(1,10):
        ...
        trainer = pl.Trainer(accelerator='cuda',
                            ...
                            logger=[pl_loggers.TensorBoardLogger('./logs/', name="finetune_EEGPT_BCIC2A_residual_adapter_tb", version=f"subject{i}"), 
                                    pl_loggers.CSVLogger('./logs/', name="finetune_EEGPT_BCIC2A_residual_adapter_csv")])
