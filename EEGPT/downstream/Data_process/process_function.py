...
root_path = "/home/infres/ttran-25/project/datasets/downstream"
...
def Load_BCIC_2a_raw_data(tmin=0, tmax=4,bandpass = [0,38],resample = None):
    ...
    data_path = "/home/infres/ttran-25/project/BCICIV_2a_gdf"
...
def Load_BCIC_2b_raw_data(tmin=0, tmax=4,bandpass = [0,38]):
    ...
    data_path = "/home/infres/ttran-25/project/BCICIV_2b_gdf"
    if bandpass is None:
...
if __name__ == '__main__':
    ...
    Load_BCIC_2a_raw_data(bandpass = None)
    # Load_BCIC_2b_raw_data(bandpass = None)
